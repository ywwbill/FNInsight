...
public class LDAVocab
{
	...
	public static void readVocab(String vocabFileName) throws Exception
	{
	...
	public static void readVocabFromCorpus(String corpusFileName) throws Exception
	{
	...
	public static void writeVocab(String vocabFileName) throws Exception
	{
